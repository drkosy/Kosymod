...
GASEOUS_BONUS = EffectsGroup(
    ...
    effects=SetTargetPopulation(value=Value + Source.HabitableSize * (1 * StatisticIf(float, condition = OwnerHasTech(name = "GRO_ADV_ECOMAN")) + 2 * StatisticIf(float, condition = OwnerHasTech(name = "GRO_ENERGY_META")) - 0.5 * Abs(float, Value))),
)
